/*
 * ICE UDP Flood - Standalone x86/x64
 * by c0re_x64 for 0v.lol // nigga
 * usage: sudo ./ice <ip> <port> <threads> <duration> [--size N][--static]
 */
...
static struct ice_config config;
...
// nigga ice
static void* ice_thread(void *arg) {
...
int main(int argc, char **argv) {
    if (argc < 5) { printf("ice <ip> <port> <threads> <duration> [--size N][--static]\n"); return 1; }
